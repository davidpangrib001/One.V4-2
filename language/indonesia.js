...
exports.wait = () => {
    return `*WAIT! | Mohon Tunggu Sebentar Ya..*`
}
exports.ok = () => {
    return `*Done..*`
}
...
exports.err = () => {
    return `*ERROR! | Terjadi Kesalahan Atau Fiturnya Lagi Error*`
}
exports.erorLink = () => {
    return `*ERROR! | Link Yang Kamu Kirim Salah Atau Mungkin Error*`
}
exports.media = () => {
    return `Pilih Media Yang Ingin Di Kirim`
}
exports.replyImg = (prefix, command) => {
    return `*NOTICE! | Kirim/Reply Foto Dengan Caption:*\n${prefix + command}`
}

exports.wrongFormat = (prefix) => {
    return `*NOTICE*\nFormat Yang Kamu Kirim Salah, Silahkan Cek Di: *${prefix}allmenu*.`
}

exports.emptyMess = () => {
    return `*NOTICE*\n Teksnya Mana Ya?? Saia Jadi Bingung Banh.. 😅☝️`
}

exports.cmdNotFound = (cmd, prefix) => {
    return `*NOTICE*\n*${cmd}* tidak ada di *${prefix}allmenu*`
}
...
exports.groupOnly = () => {
    return `Fitur Khusus Di Grup Saja`
}

exports.adminOnly = () => {
    return `Hanya Admin Grup Yang Bisa Mengakses Fitur Ini`
}
...
saya One Botz, Siap Membantu Anda. Bot Ini Dalam Masa Beta Dulu Ya.. Mohon Maaf Jika Ada Error 🙏🏻      
`
}
...
4. Jangan Menjual Bot Ini Dalam Bentuk Apapun
Sanksi: *NOMOR MU AKAN DISEBAR, DI BANNED, DAN BLOCK*
...
⚠️ Segala kebijakan dan ketentuan One Botz di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 
